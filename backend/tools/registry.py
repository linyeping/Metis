...
AVAILABLE_TOOLS: Dict[str, Callable[..., str]] = {
    ...
    "metis_rootfs_source_status": metis_rootfs_source_status,
    "metis_rootfs_asset_download": metis_rootfs_asset_download,
    "metis_rootfs_builder_status": metis_rootfs_builder_status,
    "metis_rootfs_build": metis_rootfs_build,
    "metis_rootfs_image_builder_status": metis_rootfs_image_builder_status,
    "metis_rootfs_image_build": metis_rootfs_image_build,
    "metis_runtime_bundle_package": metis_runtime_bundle_package,
    "metis_runtime_bundle_package_v2": metis_runtime_bundle_package_v2,
    "metis_runtime_bundle_prepare": metis_runtime_bundle_prepare,
    "metis_vm_direct_assets_prepare": metis_vm_direct_assets_prepare,
    "metis_vm_direct_runner_prepare": metis_vm_direct_runner_prepare,
    "metis_vm_direct_runner_smoke": metis_vm_direct_runner_smoke,
    "metis_vm_hcs_starter_prepare": metis_vm_hcs_starter_prepare,
    "metis_vm_hcs_starter_start": metis_vm_hcs_starter_start,
    "metis_vm_guest_handshake_prepare": metis_vm_guest_handshake_prepare,
    "metis_vm_guest_handshake_verify": metis_vm_guest_handshake_verify,
    "metis_vm_rootfs_boot_verifier_prepare": metis_vm_rootfs_boot_verifier_prepare,
    "metis_vm_rootfs_boot_verify": metis_vm_rootfs_boot_verify,
    "metis_vm_bundle_status": metis_vm_bundle_status,
    "metis_vm_pack_adopt_reference": metis_vm_pack_adopt_reference,
    "metis_vm_pack_scaffold": metis_vm_pack_scaffold,
    "metis_wsl_runtime_status": metis_wsl_runtime_status,
    "metis_wsl_runtime_import": metis_wsl_runtime_import,
    "metis_sandbox_status": metis_sandbox_status,
    "metis_runtime_create": metis_runtime_create,
    "metis_runtime_run": metis_runtime_run,
    "metis_runtime_collect_artifacts": metis_runtime_collect_artifacts,
    "metis_runtime_export_patch": metis_runtime_export_patch,
    "metis_runtime_export_diagnostics": metis_runtime_export_diagnostics,
    "metis_runtime_status": metis_runtime_status,
    "metis_runtime_job": metis_runtime_job,
    "metis_runtime_job_status": metis_runtime_job_status,
}
