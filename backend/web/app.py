...
def _model_capabilities_payload(overrides: Optional[Dict[str, str]] = None) -> Dict[str, Any]:
    ...
    return {
        ...
        "compact_thresholds": list(caps.compact_thresholds),
        "compactThresholds": list(caps.compact_thresholds),
        "context_source": caps.context_source,
        "contextSource": caps.context_source,
        "context_source_path": caps.context_source_path,
        "contextSourcePath": caps.context_source_path,
        "context_matched_model": caps.context_matched_model,
        "contextMatchedModel": caps.context_matched_model,
        "context_is_estimate": caps.context_is_estimate,
        "contextIsEstimate": caps.context_is_estimate,
