...
// Locations:
//
//   packaged (mac):    ~/Library/Application Support/Metis Design Prerelease/installation.json
//   packaged (win):    %APPDATA%/Metis Design Prerelease/installation.json
//   packaged (linux):  $XDG_CONFIG_HOME/Metis Design Prerelease/installation.json
