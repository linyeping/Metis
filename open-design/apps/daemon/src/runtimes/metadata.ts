...
> = {
  ...
  amr: {
    ...
    docsUrl: 'https://github.com/linyeping/Metis/blob/main/open-design/docs/new-agent-runtime-acp.md',
  },
  claude: {
  ...
  hermes: {
    installUrl: 'https://github.com/linyeping/Metis/blob/main/open-design/docs/agent-adapters.md',
