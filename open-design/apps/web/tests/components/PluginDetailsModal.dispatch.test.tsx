...
describe('PluginDetailsModal common metadata coverage', () => {
  ...
  it('routes official plugin author and source links to the Metis repo', () => {
    const html = render(
      pluginWithMeta({
    ...
    expect(html).toContain('href="https://github.com/linyeping/Metis"');
    expect(html).toContain('linyeping/Metis');
