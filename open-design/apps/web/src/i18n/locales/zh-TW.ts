...
export const zhTW: Dict = {
  ...
  "chat.amrCard.switchBody":
    "可切換到 Metis Design Cloud 官方模型服務，無需設定 API Key。完成登入、授權與儲值後，將自動重試目前任務。",
  "chat.amrCard.chipOfficial": "官方代管",
  "chat.amrCard.chipNoKey": "無需 API Key",
  "chat.amrCard.chipAutoRetry": "授權後自動重試",
  "chat.amrCard.switchCta": "切換到 Metis Design Cloud 並重試",
  "chat.amrError.authMessage":
    "Metis Design Cloud 帳號尚未授權。完成授權後將自動重試目前任務。",
  "chat.amrError.balanceMessage":
    "Metis Design Cloud 帳戶餘額不足。儲值後即可繼續執行目前任務。",
  "chat.amrError.authorizeCta": "授權並重試",
  "chat.amrError.rechargeCta": "為 Metis Design Cloud 儲值",
  "chat.amrBalanceGate.title": "升級方案，繼續創作",
  "chat.amrBalanceGate.message": "餘額不足（目前 {balance}），升級方案或儲值後，任務馬上就能開始。",
  "chat.amrBalanceGate.benefitsTitle": "Metis Design Cloud 為你提供",
  ...
  "chat.amrBalanceGate.signedOutTitle": "登入 Metis Design Cloud，開始創作",
  "chat.amrBalanceGate.signedOutMessage": "目前使用的是 Metis Design Cloud 智能體，登入後這個任務馬上就能開始。",
  ...
  "chat.runError.signInMessage.amr":
    "Metis Design Cloud 智慧體尚未登入，前往登入即可正常使用",
  "chat.runError.signInMessage.other":
    "{agent}尚未登入，請在本機檢查登入狀態。推薦使用 Metis Design Cloud 智慧體，更穩定划算",
  ...
  "chat.contextPrompt.referenceProject":
    "請把 Metis Design 專案「{name}」作為參考上下文。它的本機路徑是：{path}。在設計或修改前，如有幫助請先搜尋並讀取這個目錄。",
  ...
  "settings.welcomeTitle": "歡迎使用 Metis Design",
  "settings.welcomeSubtitle": "",
  "settings.onboardingCreateTitle": "從一句需求開始",
  "settings.onboardingCreateBody":
    "描述你想做的網站、應用、Deck、圖片或影片，Metis Design 會建立專案，並保留可繼續編輯的產出。",
  ...
  "settings.onboardingMemoryCalloutBody":
    "這些回答會構成你的記憶檔案。Metis Design 會在每個任務中重複使用它，並在你工作時持續學習。",
  ...
  "settings.onboardingCloudTitle": "登入 Metis Design",
  "settings.onboardingCloudBody":
    "登入後可直接用雲端 AI 開始設計，無需任何複雜設定。",
  "settings.onboardingCloudSignIn": "登入 Metis Design 雲端",
  ...
  "settings.onboardingGateTooltipAmr":
    "後續流程由 AI 執行，請先登入 Metis Design Cloud。",
  ...
  "settings.agentInstall.pathHint":
    "如果你透過 npm 或 Homebrew 安裝了 CLI，但仍顯示為未安裝，請確認該工具的 bin 目錄已加入 Metis Design daemon 繼承的 PATH（在 macOS 上，Terminal 與 GUI 應用的 PATH 可能不同）。請參閱 QUICKSTART.md（「Local agent CLI and PATH」章節）。",
  "settings.agentInstall.stepOpenLinks":
    "在目標代理卡片上開啟「安裝」或「文件」連結。",
  "settings.agentInstall.stepAuth":
    "返回 Metis Design 前，請先在對應 CLI 完成驗證（登入或新增 API 憑證）。",
  ...
  "settings.amrWalletRefreshTitle": "重新整理 Metis Design Cloud 錢包餘額",
  ...
  "settings.amrAccountStatus": "Metis Design Cloud 帳戶狀態",
  "settings.amrConsole": "管理",
  "settings.amrLoginErrorCompact": "Metis Design Cloud 登入失敗。",
  ...
  "settings.mcpServerHint":
    "將 Metis Design 作為 MCP 伺服器暴露給你的編碼代理。",
  ...
  "settings.privacy": "隱私",
  "settings.privacyHint": "與 Metis Design 團隊共享哪些資料",
  "settings.privacyConsentKicker": "協助我們改進 Metis Design",
  "settings.privacyConsentLead":
    "分享使用資料後，我們能更了解 Metis Design 在真實工作流裡的表現，並優先改進真正影響體驗的地方。",
  ...
  "settings.mcpHint":
    "讓其他專案中的程式碼代理（Claude Code、Cursor、VS Code、Antigravity、Zed、Windsurf）讀取您的 Metis Design 專案。您可以直接將設計匯入應用程式，無需先匯出 zip。",
  "settings.mcpDaemonError":
    "無法連線到本地守護程序以解析安裝路徑（{error}）。請確認 Metis Design 正在執行，然後重新開啟此面板。",
  ...
  "settings.mcpCapabilityDefault":
    "預設使用您在 Metis Design 中開啟的專案與檔案，因此您可以說「在我的應用程式中建置這個」，無需重新說明是哪個設計。",
  "settings.mcpRunningNote":
    "Metis Design 必須正在執行，MCP 工具呼叫才能成功。如果您在開啟 Metis Design 之前就已啟動 coding agent，請重新啟動 agent，使其能夠連線到正在執行的守護行程。",
  ...
  "entry.followXLabel": "在 X 上追蹤 @Metis DesignHQ",
  "entry.followThreadsLabel": "Follow Metis Design on Threads",
  "entry.followInstagramLabel": "在 Instagram 上追蹤 @opendesign.ai",
  "entry.followLinkedinLabel": "在 LinkedIn 上追蹤 Metis Design",
  "entry.followXiaohongshuLabel": "在小紅書上追蹤 Metis Design",
  ...
  "homeHero.chip.createPluginHint":
    "編寫可重複使用的 Metis Design 外掛並將其加入「我的外掛」。",
  ...
  "handoff.amrWebsite": "開啟 Metis Design Cloud 官網",
  ...
  "handoff.promptIntro": "請基於這個 Metis Design 專案的本機資料夾繼續實作：",
  ...
  "pluginsHome.subtitle":
    "隨附於此執行環境、可立即使用的 Metis Design 工作流程。挑選一個以載入起始提示，或瀏覽登錄檔取得更多。",
  ...
  "pluginsHome.emptyCatalog":
    "目錄是空的。內建外掛隨 Metis Design 一同提供，應會自動出現在此處 — 若問題持續發生，請嘗試重新啟動 daemon。",
  ...
  "integrations.lede":
    "連接外部系統，把 MCP 工具帶入智能體迴圈，並在其他 IDE、腳本與自動化流程中使用 Metis Design。",
  ...
  "mcpClient.daemonError":
    "無法連線到本機 daemon。請確認 Metis Design 正在執行，然後重新開啟此面板。",
  "mcpClient.saveFailed": "儲存失敗。請確認 daemon 正在執行後再試一次。",
  "useEverywhere.modalAria": "隨處使用 Metis Design",
  "useEverywhere.modalTitle": "隨處使用 Metis Design",
  "useEverywhere.modalSubtitle":
    "將 Metis Design 接入任何 IDE、Agent 或指令碼 — CLI、HTTP、MCP 及 Skills。使用「複製 Agent 指南」並貼到 Claude Code、Codex、Cursor、openclaw 或 hermes 中，即可設定一切。",
  ...
  "useEverywhere.section.overview.heading":
    "你的 Agent 在哪裡運作，Metis Design 就在哪裡運作",
  "useEverywhere.section.overview.intro":
    "Metis Design 不只是一個視窗 — 它是一個本機特權 daemon（`od`），外加一個 Skills + Design-Systems + Atoms 登錄。一旦它在您的機器上執行，任何程式碼 Agent（Claude Code、Codex、Cursor、OpenCode/openclaw、Hermes、您自己的指令碼）都能透過四個可互換的介面來驅動產生作業、檢視專案並產出設計成品。",
  "useEverywhere.section.overview.bullet1":
    "CLI — 以 `od <command>` 用於無頭指令碼、CI 及 shell 自動化。",
  "useEverywhere.section.overview.bullet2":
    "MCP server — 將 Metis Design 接成 Model Context Protocol 伺服器，讓任何支援 MCP 的 Agent 都能列出技能、執行情境並讀取成品。",
  ...
  "useEverywhere.section.overview.bullet4":
    "Skills — 隨插即用的 `SKILL.md` 套件（相容於 Claude），任何已在您 PATH 上的 Agent 完全無需 Metis Design 即可調用。",
  ...
  "useEverywhere.section.cli.heading": "從任何 shell 操作 Metis Design",
  ...
  "useEverywhere.section.mcp.heading":
    "將 Metis Design 以 MCP 伺服器形式開放給任何程式設計 Agent",
  "useEverywhere.section.mcp.intro":
    "Metis Design 隨附一個 Model Context Protocol 伺服器（`od mcp`），讓任何支援 MCP 的用戶端 — Cursor、Claude Code、Antigravity、VS Code Copilot Chat、openclaw、hermes — 都能探索 Metis Design 工具（列出技能、算繪預覽、產生媒體、執行外掛），而無需手動使用 shell。daemon 透過 `GET /api/mcp/install-info` 為每個主要用戶端發布可直接貼上的安裝程式碼片段。",
  ...
  "useEverywhere.section.mcp.footer":
    "在 Metis Design 應用程式中，開啟「設定 → 整合」即可複製特定用戶端的安裝指令（Cursor、Claude Code、Antigravity、VS Code），而無需手動編輯 JSON。",
  ...
  "useEverywhere.section.skills.heading":
    "適用於任何 Agent 的隨插即用 Skills — 即使 Metis Design 未在執行也行",
  "useEverywhere.section.skills.intro":
    "Skill 是一個包含相容於 Claude 的 `SKILL.md`（YAML 前置資料 + 內文）的目錄。Metis Design 以 `od:` 命名空間（`mode`、`preview`、`design_system`、`inputs`、…）擴充此格式，因此同一個成品既能在 Metis Design 內使用，也能被像 Claude Code、Codex、openclaw 或 hermes 這類原生 Agent 使用。探索作業遵循一條優先順序鏈，因此專案可覆寫自己的技能。",
  ...
  "useEverywhere.section.skills.snippet1":
    "最精簡的 SKILL.md（Claude 相容的前置資料 + Metis Design 額外設定）",
  ...
  "entry.githubStarAria": "在 GitHub 為 Metis Design 點亮 Star",
  ...
  "newproj.locationDefault": "Metis Design 專案",
  ...
  "avatar.amrConsole": "Metis Design Cloud 帳戶",
  ...
  "socialShare.openDesignText":
    "Metis Design 是開源的設計智慧工作區，可以生成、編輯、部署並交付設計產物。",
  ...
  "socialShare.projectText":
    "我用 Metis Design 做了 {title}。查看已部署產物，也推薦收藏倉庫：{repo}",
  "socialShare.projectCopyText":
    "我用 Metis Design 做了 {title}\n{url}\nMetis Design 倉庫：{repo}",
  ...
  "chat.brandBrowserAssistDesktopOnly":
    "瀏覽器輔助需要桌面應用，Metis Design 才能讀取即時瀏覽器頁面。",
  "chat.brandBrowserAssistReadFailed":
    "無法讀取瀏覽器頁面。請確認品牌網站已開啟並完整載入。",
  "chat.brandBrowserAssistMessage":
    "Metis Design 需要瀏覽器輔助才能完成這次品牌擷取。請先在 Browser 分頁清除頁面攔截，然後在下方確認。",
  "brandEnrichment.title": "AI 優化",
  "brandEnrichment.body":
    "Metis Design 會在背景執行更深度的抽取，自動套用合適的設計系統 skills，並就地更新這個系統。通常需要 10-20 分鐘，你可以繼續做其他事。",
  ...
  "chat.activeFilePlaceholder": "讓 Metis Design 修改 {file}...",
  ...
  "chat.mode.design.solves":
    "當你希望 Metis Design 產生檔案、更新 workspace，或把需求變成多模態可交付結果時使用。",
  ...
  "preview.errorBody":
    "範例 HTML 載入失敗。請確認 Metis Design 正在執行後重試。",
  "preview.retry": "重試",
  ...
  "designFiles.documentTemplate.goalBody":
    "說明希望 Metis Design 基於這份文件生成、修改或判斷什麼。",
  ...
  "designFiles.documentTemplate.capabilityAgent":
    "Metis Design agent 可以讀取、編輯這份檔案，並把它作為專案上下文。",
  ...
  "designFiles.documentTemplate.nextBody":
    "檢查並編輯這份文件，然後讓 Metis Design 基於它生成、修改或執行操作。",
  ...
  "designFiles.usefulInfoTip18":
    "在 YouTube 上訂閱 Metis Design，觀看教學和示範。",
  "designFiles.usefulInfoTip19":
    "在 LinkedIn 上追蹤 Metis Design，了解產品動態。",
  "designFiles.usefulInfoTip20":
    "在小紅書上追蹤 Metis Design，獲取技巧和靈感。",
  ...
  "pet.navHint": "領養與自訂",
  "pet.tabBuiltIn": "內建",
  "pet.tabBuiltInHint": "Metis Design 內建的精選寵物 — 一鍵領養。",
  "pet.builtInEmpty":
  ...
  "pet.codexBundled": "內建",
  "pet.codexBundledTitle": "Metis Design 內建寵物，無需下載。",
  ...
  "settings.projectLocationsDescription":
    "新增可包含多個 Metis Design 專案資料夾的工作基目錄。新專案會儲存為所選基目錄中的一個資料夾。",
  ...
  "settings.customInstructionsHint":
    "Metis Design 在每次聊天中都應遵循的固定指示。將事實、偏好與專案脈絡儲存為記憶。",
  ...
  "artifact.odCardBrandAssistBody":
    "在瀏覽器中開啟品牌網站，讓 Metis Design 繼續擷取此設計體系。",
  ...
  "updater.availableBody":
    "Metis Design {version} 可用。下載完成後即可開啟安裝器。",
  ...
  "updater.installerOpenBody":
    "安裝器已開啟。Metis Design 正在結束，以便你完成更新。",
  ...
  "updater.payloadReadyGeneric":
    "A new Metis Design update is ready. Metis Design will close and restart automatically.",
  "updater.payloadReadyVersion":
    "Metis Design {version} is ready. Metis Design will close and restart automatically.",
  "updater.quitButton": "結束 Metis Design",
  "updater.quitFailedBody":
    "安裝器已開啟，但 Metis Design 無法結束。替換應用程式前請先結束 Metis Design。",
  "updater.quitFailedTitle": "無法結束",
  "updater.quitting": "正在結束…",
  "updater.ready": "更新已就緒",
  "updater.readyGeneric": "新版本已就緒。Metis Design 會關閉並開啟安裝器。",
  "updater.readyVersion":
    "Metis Design {version} 已就緒。Metis Design 會關閉並開啟安裝器。",
  ...
  'settings.updateQuitFailed': '安裝程式已開啟，但 Metis Design 未能自動結束。',
  ...
  "dsManager.createBody":
    "把你的品牌、產品、程式碼、素材與設計參考教給 Metis Design。",
  ...
  "settings.customInstructionsDesc":
    "Metis Design 在每次對話中都會遵循的固定指令。它們不是儲存的記憶；事實、偏好與專案脈絡請使用「記憶」。",
  ...
  "brand.librarySubtitle":
    "把你的品牌套件教給 Metis Design——從網站擷取一個品牌套件，然後在任意對話中套用它。",
  ...
  "onboarding.buildBody":
    "Metis Design 將你的品牌沉澱為可重用的設計系統,讓你之後打造的一切都保持品牌一致。",
  ...
  "dsCreate.sourceSectionBody":
    "從 GitHub repo、網站、DESIGN.md 或能體現風格的檔案開始。Metis Design 會先快速建立一套可用系統，之後 AI 可在專案中繼續細化。",
  ...
  "ds.extractionRunningBody": "Metis Design 正在就地更新此體系。",
  ...
  "ds.sectionRunningReadingContext":
    "Metis Design 正在讀取 {title} 的段落上下文。",
  ...
  "ds.repoConnectBannerBody":
    "連接 GitHub 後，Metis Design 可以讀取你的儲存庫，並把顏色、字體和元件擷取到此設計體系中。",
