...
export const en: Dict = {
  ...
  'chat.amrCard.switchBody': 'Switch to Metis Design Cloud — no API key setup needed. After you sign in, authorize, and top up, this run retries automatically.',
  ...
  'chat.amrCard.switchCta': 'Switch to Metis Design Cloud & retry',
  'chat.amrError.authMessage': 'Your Metis Design Cloud account isn\'t authorized yet. Authorize it and this run retries automatically.',
  'chat.amrError.balanceMessage': 'Your Metis Design Cloud balance has run out. Top up to keep this run going.',
  ...
  'chat.amrBalanceGate.benefitsTitle': 'What you get with Metis Design Cloud',
  ...
  'chat.amrBalanceGate.signedOutMessage': 'You\'re using the Metis Design Cloud agent — sign in and this task can start right away.',
  ...
  'chat.runError.signInMessage.amr': 'The Metis Design Cloud agent isn\'t signed in yet — sign in to start using it.',
  'chat.runError.signInMessage.other': '{agent} isn\'t signed in. Check its sign-in status locally. We recommend the Metis Design Cloud agent — steadier and better value.',
  ...
  'settings.welcomeTitle': 'Welcome to Metis Design',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'Start from a brief',
  'settings.onboardingCreateBody': 'Describe the site, app, deck, image, or video you want. Metis Design will create a project and keep the work editable.',
  ...
  'settings.onboardingMemoryCalloutBody': 'These answers seed your Memory profile. Metis Design reuses it on every task — and keeps learning as you work.',
  ...
  'settings.onboardingCloudTitle': 'Sign in to Metis Design',
  'settings.onboardingCloudBody': 'Sign in to start designing with cloud AI right away — no complex setup required.',
  'settings.onboardingCloudSignIn': 'Sign in to Metis Design',
  ...
  'settings.onboardingGateTooltipAmr': 'The next steps run on AI — sign in to Metis Design Cloud to continue.',
  ...
  'settings.agentInstall.pathHint': 'If you installed a CLI with npm or Homebrew and it still shows as not installed, ensure the tool\'s bin directory is on the PATH the Metis Design daemon inherits (Terminal vs GUI apps can differ on macOS). See QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Open Install or Docs for your preferred agent.',
  'settings.agentInstall.stepAuth': 'Authenticate with the vendor CLI (sign in or add API credentials) before returning to Metis Design.',
  ...
  'settings.amrAccountStatus': 'Metis Design Cloud account status',
  ...
  'settings.mcpServerHint': 'Expose Metis Design as an MCP server for your coding agent.',
  ...
  'settings.privacyHint': 'What data is shared with the Metis Design team',
  'settings.privacyConsentKicker': 'Help us improve Metis Design',
  'settings.privacyConsentLead': 'Sharing usage data helps us understand how Metis Design performs in real workflows, so we can improve the parts that matter most to your experience.',
  ...
  "settings.allowSilentUpdatesDesc": "When an in-app update is ready, install it automatically the next time Metis Design starts. Does not upgrade the current session. Installer updates still ask first.",
  ...
  'settings.updateQuitFailed': 'The installer opened, but Metis Design could not quit automatically.',
  ...
  'settings.mcpHint': 'Let coding agents (Cursor, Claude Code, VS Code…) read your Metis Design projects directly.',
  'settings.mcpDaemonError': 'Couldn\'t reach the local daemon to resolve install paths ({error}). Make sure Metis Design is running, then reopen this panel.',
  ...
  'settings.mcpCapabilityDefault': 'Default to the project and file you have open in Metis Design, so you can say "build this in my app" without re-stating which design.',
  'settings.mcpRunningNote': 'Metis Design must be running for MCP tool calls to succeed. If you started your coding agent before opening Metis Design, restart the agent so it can reach the live daemon.',
  ...
  'entry.discordAria': 'Join the Metis Design Discord',
  'entry.discordAriaWithOnline': 'Join the Metis Design Discord - {online}',
  'entry.discordOnlineLabel': '{count} online',
  'entry.followXLabel': 'Follow @Metis DesignHQ on X',
  ...
  'entry.followLinkedinLabel': 'Follow Metis Design on LinkedIn',
  'entry.followXiaohongshuLabel': 'Follow Metis Design on Xiaohongshu',
  ...
  'homeHero.chip.createPluginHint': 'Author a reusable Metis Design plugin and add it to My plugins.',
  ...
  'handoff.amrWebsite': 'Visit Metis Design Cloud',
  ...
  'handoff.promptIntro': 'Continue from this local Metis Design project folder:',
  ...
  'designSystemPicker.noPreview': 'No preview page. Metis Design Systems to view the full preview.',
  ...
  'pluginsHome.subtitle': 'Ready-to-use Metis Design workflows bundled with this runtime. Pick one to load a starter prompt, or browse the registry for more.',
  'pluginsHome.browseRegistry': 'Browse registry',
  'pluginsHome.count': '{filtered} of {total}',
  'pluginsHome.loadingCatalog': 'Loading catalog…',
  'pluginsHome.emptyCatalog': 'Catalog is empty. Bundled plugins ship with Metis Design and should appear here automatically — try restarting the daemon if this persists.',
  ...
  'mcpClient.daemonError': 'Could not reach the local daemon. Make sure Metis Design is running, then reopen this panel.',
  'mcpClient.saveFailed': 'Save failed. Check that the daemon is running and try again.',
  'useEverywhere.modalAria': 'Use Metis Design everywhere',
  'useEverywhere.modalTitle': 'Use Metis Design everywhere',
  'useEverywhere.modalSubtitle': 'Drop Metis Design into any IDE, agent, or script — CLI, HTTP, MCP, and Skills. Use “Copy guide for an agent” and paste into Claude Code, Codex, Cursor, openclaw, or hermes to set up everything.',
  ...
  'useEverywhere.section.overview.heading': 'Metis Design works wherever your agent works',
  'useEverywhere.section.overview.intro': 'Metis Design is more than a window — it is a local privileged daemon (`od`) plus a Skills + Design-Systems + Atoms registry. Once it is running on your machine, any code agent (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, your own script) can drive generations, inspect projects, and produce design artifacts through four interchangeable surfaces.',
  'useEverywhere.section.overview.bullet1': 'CLI — `od <command>` for headless scripts, CI, and shell automation.',
  'useEverywhere.section.overview.bullet2': 'MCP server — wires Metis Design as a Model Context Protocol server so any MCP-capable agent can list skills, run scenarios, and read artifacts.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — drop-in `SKILL.md` packs (Claude-compatible) that any agent already on your PATH can invoke without Metis Design at all.',
  ...
  'useEverywhere.section.cli.heading': 'Drive Metis Design from any shell',
  ...
  'useEverywhere.section.mcp.heading': 'Expose Metis Design as an MCP server to any coding agent',
  'useEverywhere.section.mcp.intro': 'Metis Design ships with a Model Context Protocol server (`od mcp`) that lets any MCP-capable client — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — discover Metis Design tools (list skills, render previews, generate media, run plugins) without shelling out manually. The daemon publishes a ready-to-paste install snippet via `GET /api/mcp/install-info` for each major client.',
  ...
  'useEverywhere.section.mcp.footer': 'In the Metis Design app, open Settings → Integrations to copy a client-specific install command (Cursor, Claude Code, Antigravity, VS Code) instead of editing JSON by hand.',
  ...
  'useEverywhere.section.skills.heading': 'Drop-in Skills for any agent — even without Metis Design running',
  'useEverywhere.section.skills.intro': 'A Skill is a directory with a Claude-compatible `SKILL.md` (YAML front-matter + body). Metis Design extends the format with the `od:` namespace (`mode`, `preview`, `design_system`, `inputs`, …) so the same artifact can be used both inside Metis Design and by a vanilla agent like Claude Code, Codex, openclaw, or hermes. Discovery follows a precedence chain so projects can override their own skills.',
  ...
  'useEverywhere.section.skills.snippet1': 'Minimal SKILL.md (Claude-compatible front matter + Metis Design extras)',
  ...
  'entry.githubStarAria': 'Star Metis Design on GitHub',
  ...
  'newproj.locationDefault': 'Metis Design projects',
  ...
  'avatar.amrConsole': 'Metis Design Cloud',
  ...
  'socialShare.openDesignSection': 'Share Metis Design',
  'socialShare.openDesignTitle': 'Metis Design on GitHub',
  'socialShare.openDesignText': 'Metis Design is an open-source workspace for creating, editing, deploying, and handing off design artifacts.',
  ...
  'socialShare.projectText': 'Built with Metis Design: {title}. View the deployed artifact and star the repo: {repo}',
  'socialShare.projectCopyText': 'Built with Metis Design: {title}\n{url}\nMetis Design repo: {repo}',
  ...
  'brandEnrichment.body': "Metis Design will run a deeper extraction in the background, apply the right design-system skills automatically, and update this system in place. This can take 10-20 minutes; you can keep working.",
  ...
  'chat.activeFilePlaceholder': 'Ask Metis Design to change {file}...',
  ...
  'chat.mode.design.solves': 'Use it when you want Metis Design to generate files, update the workspace, or turn a brief into multimodal deliverables.',
  ...
  'preview.errorBody': 'The example HTML failed to fetch. Make sure Metis Design is running and try again.',
  'preview.retry': 'Retry',
  ...
  'designFiles.usefulInfoTip7': 'Enjoying Metis Design? Star us on GitHub.',
  'designFiles.usefulInfoTip8': 'Follow @Metis DesignHQ on X for the latest updates.',
  ...
  'designFiles.usefulInfoTip18': 'Subscribe to Metis Design on YouTube for tutorials and demos.',
  'designFiles.usefulInfoTip19': 'Follow Metis Design on LinkedIn for product news.',
  'designFiles.usefulInfoTip20': 'Follow Metis Design on Xiaohongshu for tips and inspiration.',
  ...
  'assistant.shareToOpenDesign': 'Share to Metis Design',
  ...
  'pet.tabBuiltInHint': 'Curated companions bundled with Metis Design — pick one and adopt.',
  ...
  'pet.codexBundledTitle': 'Ships with Metis Design — no download needed.',
  ...
  'settings.projectLocationsDescription': 'Add work bases that can contain multiple Metis Design project folders. New projects are saved as one folder inside the selected base.',
  ...
  'settings.customInstructionsHint': 'Fixed instructions Metis Design should follow in every chat. Save facts, preferences, and project context as memories.',
  ...
  'updater.availableBody': 'Metis Design {version} is available. It will download before the installer can open.',
  ...
  'updater.installerOpenBody': 'The installer is open. Metis Design is quitting so you can finish the update.',
  ...
  'updater.quitButton': 'Quit Metis Design',
  'updater.quitFailedBody': 'The installer is open, but Metis Design could not quit. Quit Metis Design before replacing the app.',
  'updater.quitFailedTitle': 'Could not quit',
  'updater.quitting': 'Quitting...',
  'updater.ready': 'Update ready',
  'updater.readyGeneric': 'A new version is ready. Metis Design will close and open the installer.',
  'updater.readyVersion': 'Metis Design {version} is ready. Metis Design will close and open the installer.',
  ...
  'dsManager.createBody': 'Teach Metis Design your brand, product, code, assets, and design references.',
  ...
  'settings.customInstructionsDesc': 'Fixed instructions Metis Design follows in every chat. These are not saved memories; use Memory for facts, preferences, and project context.',
  ...
  'brand.librarySubtitle': 'Teach Metis Design your design systems — extract one from a website, then apply it in any chat.',
  ...
  'onboarding.buildBody': 'Metis Design turns your brand into a reusable design system — then keeps everything you build on-brand and consistent.',
