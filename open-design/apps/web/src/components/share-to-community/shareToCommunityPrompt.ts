...
export const SHARE_TO_COMMUNITY_PROMPT = [
  'Package the work I just finished in this project as a Metis Design plugin so I can install it into My plugins and open a PR to the Metis Design community catalog.',
  '',
  ...
  '- **Metis Design PR** — opens a draft PR against `linyeping/Metis` for the community catalog.',
  '',
