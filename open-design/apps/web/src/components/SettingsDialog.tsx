...
const OPEN_DESIGN_RELEASES_URL = 'https://github.com/linyeping/Metis/releases';
...
function displayAgentName(agent: Pick<AgentInfo, 'id' | 'name'>): string {
  return agent.id === 'amr' ? 'Metis Design' : agent.name;
}
...
// `od` we might add to PATH, and most Metis Design users run from
