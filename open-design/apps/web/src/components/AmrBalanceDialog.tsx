...
interface Props {
  ...
  /** Metis Design Cloud profile from the blocking snapshot; picks the console origin. */
  profile: string | null;
...
// HARD pre-run blocker for Metis Design Cloud tasks: the run cannot possibly
...
//
//   signed_out — Metis Design Cloud selected but no account session. The CTA
...
export function AmrBalanceDialog({
  ...
  const openWallet = () => {
    ...
    // Same attribution handshake as the other Metis Design Cloud handoffs
