...
const EN: CommunityCopy = {
  hub: {
    title: 'Community — Metis Design',
    desc: 'The Metis Design community: contributors shipping in public, ambassadors hosting local ateliers, and moderators keeping the Discord warm.',
    heroTitle: 'Open design <em>takes shape</em><br/>when you ship it.',
    heroLead:
      'Metis Design is built by people, in public. Skills, DESIGN.md systems, plugins, docs: every commit is a brushstroke. Pick a door below, find your room.',
    cardMetaH: 'Auto-minted on first merge',
    cardMetaS: 'PNG · shared on X',
    cardHeroAlt:
      'Metis Design contributor honor card — @dev-kp-eloper, top 99.9%, Giotto tier',
    cards: [
      {
        ord: 'I',
        title: 'Contributors',
      ...
      },
      {
        ord: 'II',
        title: 'Ambassadors',
        sub: "Metis Design's <em>voice</em> in your city.",
  ...
  contributors: {
    title: 'Contributors — Metis Design',
    desc: 'Contribute to Metis Design: maintainers, weekly and all-time contributor leaderboards, good first issues, and a zero-code path to ship your first piece.',
    heroTitle: 'The hands that <em>ship</em> the work.',
    heroLead:
      "Metis Design is built by people, in public. Skills, DESIGN.md systems, plugins, docs: every commit is a brushstroke. Pick an issue, send a PR, and earn a one-of-one honor card the moment you're merged.",
    showcase: {
      kicker: 'Plugin everything',
      h2: 'Metis Design as a stage. <em>Your work</em> as the show.',
      intro:
        ...
        steps: [
          {
            ...
            body: 'Paste the command above into the agent within Metis Design, or into whichever you already keep at hand: Claude Code, Codex, Cursor. It installs itself.',
          },
          {
            h4: 'Wake the skill',
    ...
    maintainers: {
      ...
      intro:
        'Maintainers protect the direction and quality of Metis Design: they review contributions, keep the standard coherent, and make room for more contributors to earn their place in the project.',
      role: 'Maintainer',
      bios: {
        'Nagendhra-web':
          "Nagendhra brings a data engineer's instinct for production truth: find the failure, measure the edge case, and fix it properly. In Metis Design, that shows up in deploy preflight work, asset-bundling hardening, and Windows fixes that make the project feel trustworthy when contributors ship.",
        'Sid-Qin':
          "Sid is the generalist engineer with a designer's eye for detail: the kind of maintainer who notices both the broken CLI path and the crooked interaction affordance. In Metis Design, Sid keeps export flows, plugin actions, Windows shims, MIME handling, and agent plumbing sharp enough for a community to build on.",
      },
    },
    allTime: {
      ...
      intro:
        'A long-running record of talented contributors who keep turning ideas, fixes, and craft into the shared Metis Design standard.',
    ...
    weekly: {
      ...
      intro:
        'A snapshot of sharp contributors landing PRs, improving the product, and making Metis Design feel alive.',
      rankLabel: "This week's leader",
      week: 'Last 7 days',
      handleSuffix: '· leading this week',
      blurbTemplate:
        '{name} is setting the pace this week with {prs} merged PRs and the kind of steady craft that keeps Metis Design moving.',
      statRank: 'Rank',
      statPrs: 'PRs · 7d',
      headContributor: 'Contributor',
      headPrs: 'PRs',
    ...
    issues: {
      ...
      intro:
        'Live from <span class="num">label:&ldquo;good first issue&rdquo;</span> on the Metis Design repo. Comment on an issue to claim it, and a maintainer will assign it within a day.',
  ...
  ambassadors: {
    title: 'Ambassadors — Metis Design',
    desc: "Become an Metis Design ambassador: open a local atelier, host meetups and critiques, and get budget, materials, and a private channel to the core team.",
    heroTitle: "Be Metis Design's <em>voice</em> in your city.",
    heroLead:
    ...
    program: {
      ...
      applyNote:
        'Ambassadors turn Metis Design from a repository into something contributors can meet in a room, with ink on the table and coffee gone cold.',
      cols: [
        {
          n: 'I · Vocation',
    ...
    roster: {
      ...
      intro:
        'Local organizers, creators, and community builders helping Metis Design reach more designers and teams.',
      places: [
  ...
  moderators: {
    title: 'Moderators — Metis Design',
    desc: 'Meet the Metis Design Discord moderators and join the room where AI-native designers ship work, open plugins, break betas, and pull one another unstuck.',
      ...
      cards: [
        {
          ...
          bio: 'From the Metis Design founding team. Hopes the Discord stays a good place to be. Wave at any time, on any question.',
        },
        {
          role: 'Steward of the room',
          bio: 'A practiced hand at Discord and community-tending. Keeps the room warm, the doors open, the conversation flowing. Passionate about Metis Design.',
        },
      ],
