...
const EN: PricingContent = {
  labels: {
    ...
    consoleLabel: 'Metis Design Cloud console',
    monthly: 'Monthly',
    yearly: 'Yearly',
...
const ZH_CN: PricingContent = {
  labels: {
    ...
    consoleLabel: 'Metis Design Cloud 控制台',
    monthly: '月付',
    yearly: '年付',
    yearlySave: '省最多 51%',
    perMonth: '/月',
...
const ZH_TW: PricingContent = {
  labels: {
    ...
    consoleLabel: 'Metis Design Cloud 主控台',
    monthly: '月付',
    yearly: '年付',
    yearlySave: '最多省 51%',
    perMonth: '/ 月',
...
const ES: PricingContent = {
  labels: {
    ...
    consoleLabel: 'consola de Metis Design Cloud',
    monthly: 'Mensual',
    yearly: 'Anual',
...
const PT_BR: PricingContent = {
  labels: {
    ...
    consoleLabel: 'console do Metis Design Cloud',
    monthly: 'Mensal',
    yearly: 'Anual',
...
const RU: PricingContent = {
  labels: {
    ...
    consoleLabel: 'консоли Metis Design Cloud',
    monthly: 'Месяц',
    yearly: 'Год',
...
const FR: PricingContent = {
  labels: {
    ...
    consoleLabel: 'console Metis Design Cloud',
    monthly: 'Mensuel',
    yearly: 'Annuel',
...
const KO: PricingContent = {
  labels: {
    ...
    consoleLabel: 'Metis Design Cloud 콘솔',
    monthly: '월간',
    yearly: '연간',
    yearlySave: '최대 51% 절약',
    perMonth: '/월',
...
const DE: PricingContent = {
  labels: {
    ...
    consoleLabel: 'Metis Design Cloud Konsole',
    monthly: 'Monatlich',
    yearly: 'Jährlich',
...
const JA: PricingContent = {
  labels: {
    ...
    consoleLabel: 'Metis Design Cloud コンソール',
    monthly: '月額',
    yearly: '年額',
    yearlySave: '最大 51% オフ',
    perMonth: '/ 月',
