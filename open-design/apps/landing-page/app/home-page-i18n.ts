...
> = {
  fr: homeFallbackCopy({
    railRight: 'Metis Design — vol. 01 · no 26 · Apache-2.0',
    railLeft: 'Skills · systèmes · agents · BYOK · local d’abord',
    discordAria: 'Rejoindre le Discord Metis Design',
    ...
    heroLead: (skills, systems) =>
      `Metis Design est l’alternative officielle, local-first, à Claude Design. Votre agent de code — Claude Code, Codex, Cursor, Gemini, OpenCode ou Qwen — devient un moteur de design avec ${skills} skills composables et ${systems} systèmes DESIGN.md portables.`,
    ...
    officialAria: 'Source officielle Metis Design',
    ...
    about: {
      ...
      caption: 'Études de forme · perception · imagination machinique. (Metis Design, MMXXVI)',
    },
    capabilities: {
    ...
    work: {
      ...
      editedBy: 'Édité par Metis Design',
    ...
    testimonial: {
      ...
      quote: '« Metis Design a transformé des idées IA floues en un système visuel net, crédible et réellement nouveau. »',
  ...
  ru: homeFallbackCopy({
    railRight: 'Metis Design — том 01 · выпуск № 26 · Apache-2.0',
    railLeft: 'Skills · системы · агенты · BYOK · local-first',
    discordAria: 'Присоединиться к Discord Metis Design',
    ...
    heroLead: (skills, systems) =>
      `Metis Design — официальная local-first альтернатива Claude Design. Ваш coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode или Qwen — становится дизайн-движком с ${skills} составными skills и ${systems} переносимыми DESIGN.md-системами.`,
    ...
    officialAria: 'Официальный источник Metis Design',
    ...
    about: {
      ...
      caption: 'Исследования формы · восприятия · машинного воображения. (Metis Design, MMXXVI)',
    },
    capabilities: {
    ...
    work: {
      ...
      editedBy: 'Редакция Metis Design',
    ...
    testimonial: {
      ...
      label: 'Соавторы',
      quote: '«Metis Design помог превратить расплывчатые AI-идеи в четкую, надежную и действительно новую визуальную систему.»',
  ...
  es: homeFallbackCopy({
    railRight: 'Metis Design — vol. 01 · número 26 · Apache-2.0',
    railLeft: 'Skills · sistemas · agentes · BYOK · local-first',
    discordAria: 'Unirse al Discord de Metis Design',
    ...
    heroLead: (skills, systems) =>
      `Metis Design es la alternativa oficial, local-first, a Claude Design. Tu agente de código — Claude Code, Codex, Cursor, Gemini, OpenCode o Qwen — se convierte en un motor de diseño con ${skills} skills componibles y ${systems} sistemas DESIGN.md portables.`,
    ...
    officialAria: 'Fuente oficial de Metis Design',
    ...
    about: {
      ...
      caption: 'Estudios de forma · percepción · imaginación maquínica. (Metis Design, MMXXVI)',
    },
    capabilities: {
    ...
    work: {
      ...
      editedBy: 'Editado por Metis Design',
    ...
    testimonial: {
      ...
      label: 'Colaboradores',
      quote: '«Metis Design convirtió ideas de IA borrosas en un sistema visual nítido, creíble y realmente nuevo.»',
  ...
  'pt-br': homeFallbackCopy({
    railRight: 'Metis Design — vol. 01 · edição nº 26 · Apache-2.0',
    railLeft: 'Skills · sistemas · agentes · BYOK · local-first',
    discordAria: 'Entrar no Discord do Metis Design',
    ...
    heroLead: (skills, systems) =>
      `Metis Design é a alternativa oficial, local-first, ao Claude Design. Seu agente de código — Claude Code, Codex, Cursor, Gemini, OpenCode ou Qwen — vira um motor de design com ${skills} skills componíveis e ${systems} sistemas DESIGN.md portáteis.`,
    ...
    officialAria: 'Fonte oficial do Metis Design',
    ...
    about: {
      ...
      caption: 'Estudos de forma · percepção · imaginação maquínica. (Metis Design, MMXXVI)',
    },
    capabilities: {
      rule: 'Capacidades · skills · sistemas',
    ...
    testimonial: {
      ...
      label: 'Colaboradores',
      quote: '“Metis Design transformou ideias vagas de IA em um sistema visual nítido, confiável e realmente novo.”',
  ...
  it: homeFallbackCopy({
    railRight: 'Metis Design — vol. 01 · numero 26 · Apache-2.0',
    railLeft: 'Skill · sistemi · agenti · BYOK · local-first',
    discordAria: 'Entra nel Discord di Metis Design',
    ...
    heroLead: (skills, systems) =>
      `Metis Design è l’alternativa ufficiale, local-first, a Claude Design. Il tuo agente di codice — Claude Code, Codex, Cursor, Gemini, OpenCode o Qwen — diventa un motore di design con ${skills} skill componibili e ${systems} sistemi DESIGN.md portabili.`,
    ...
    officialAria: 'Fonte ufficiale Metis Design',
    ...
    about: {
      ...
      caption: 'Studi di forma · percezione · immaginazione macchinica. (Metis Design, MMXXVI)',
    },
    capabilities: {
    ...
    work: {
      ...
      editedBy: 'Redazione Metis Design',
    ...
    testimonial: {
      ...
      label: 'Collaboratori',
      quote: '“Metis Design ha trasformato idee AI vaghe in un sistema visivo nitido, credibile e davvero nuovo.”',
  ...
  vi: homeFallbackCopy({
    railRight: 'Metis Design — tập 01 · số 26 · Apache-2.0',
    railLeft: 'Skill · hệ thống · agent · BYOK · ưu tiên local',
    discordAria: 'Tham gia Discord Metis Design',
    ...
    heroLead: (skills, systems) =>
      `Metis Design là lựa chọn chính thức, ưu tiên local, thay Claude Design. Agent viết code bạn đang dùng — Claude Code, Codex, Cursor, Gemini, OpenCode hoặc Qwen — trở thành engine thiết kế với ${skills} skill có thể ghép và ${systems} hệ DESIGN.md di động.`,
    ...
    officialAria: 'Nguồn chính thức của Metis Design',
    ...
    about: {
      ...
      caption: 'Nghiên cứu hình thái · tri giác · tưởng tượng máy. (Metis Design, MMXXVI)',
    },
    capabilities: {
    ...
    work: {
      ...
      editedBy: 'Biên tập bởi Metis Design',
    ...
    testimonial: {
      ...
      label: 'Cộng tác viên',
      quote: '“Metis Design biến ý tưởng AI mơ hồ thành một hệ thị giác sắc nét, đáng tin và thật sự mới.”',
  ...
  pl: homeFallbackCopy({
    railRight: 'Metis Design — tom 01 · wydanie nr 26 · Apache-2.0',
    railLeft: 'Skills · systemy · agenci · BYOK · lokalnie najpierw',
    discordAria: 'Dołącz do Discorda Metis Design',
    ...
    heroLead: (skills, systems) =>
      `Metis Design to oficjalna, lokalna z założenia alternatywa dla Claude Design. Twój agent do kodu — Claude Code, Codex, Cursor, Gemini, OpenCode albo Qwen — staje się silnikiem designu z ${skills} kompozycyjnymi skills i ${systems} przenośnymi systemami DESIGN.md.`,
    ...
    officialAria: 'Oficjalne źródło Metis Design',
    ...
    about: {
      ...
      caption: 'Studia formy · percepcji · wyobraźni maszynowej. (Metis Design, MMXXVI)',
    },
    capabilities: {
    ...
    work: {
      ...
      editedBy: 'Redakcja Metis Design',
      label: 'Wybrane prace',
    ...
    testimonial: {
      ...
      quote: '„Metis Design zmienił niejasne idee AI w ostry, wiarygodny i naprawdę nowy system wizualny.”',
  ...
  id: homeFallbackCopy({
    railRight: 'Metis Design — vol. 01 · edisi nº 26 · Apache-2.0',
    railLeft: 'Skill · sistem · agent · BYOK · local-first',
    discordAria: 'Bergabung ke Discord Metis Design',
    ...
    heroLead: (skills, systems) =>
      `Metis Design adalah alternatif resmi, local-first, untuk Claude Design. Agent coding yang sudah Anda pakai — Claude Code, Codex, Cursor, Gemini, OpenCode, atau Qwen — menjadi mesin desain dengan ${skills} skill komposable dan ${systems} sistem DESIGN.md portabel.`,
    ...
    officialAria: 'Sumber resmi Metis Design',
    ...
    about: {
      ...
      caption: 'Studi bentuk · persepsi · imajinasi mesin. (Metis Design, MMXXVI)',
    },
    capabilities: {
    ...
    work: {
      ...
      editedBy: 'Disunting Metis Design',
      label: 'Karya pilihan',
    ...
    testimonial: {
      ...
      label: 'Kolaborator',
      quote: '“Metis Design mengubah ide AI yang samar menjadi sistem visual yang tajam, dapat dipercaya, dan benar-benar baru.”',
  ...
  nl: homeFallbackCopy({
    railRight: 'Metis Design — deel 01 · nummer 26 · Apache-2.0',
    railLeft: 'Skills · systemen · agents · BYOK · local-first',
    discordAria: 'Word lid van Metis Design Discord',
    ...
    heroLead: (skills, systems) =>
      `Metis Design is het officiële local-first alternatief voor Claude Design. Je bestaande code-agent — Claude Code, Codex, Cursor, Gemini, OpenCode of Qwen — wordt een design-engine met ${skills} combineerbare skills en ${systems} draagbare DESIGN.md-systemen.`,
    ...
    officialAria: 'Officiële bron van Metis Design',
    ...
    about: {
      ...
      caption: 'Studies naar vorm · perceptie · machinale verbeelding. (Metis Design, MMXXVI)',
    },
    capabilities: {
    ...
    work: {
      ...
      editedBy: 'Metis Design-redactie',
    ...
    testimonial: {
      ...
      label: 'Samenwerkers',
      quote: '“Metis Design veranderde vage AI-ideeën in een scherp, geloofwaardig en echt nieuw visueel systeem.”',
  ...
  ar: homeFallbackCopy({
    railRight: 'Metis Design — المجلد 01 · العدد 26 · Apache-2.0',
    railLeft: 'Skills · أنظمة · Agents · BYOK · محلي أولاً',
    discordAria: 'الانضمام إلى Discord الخاص بـ Metis Design',
    ...
    heroLead: (skills, systems) =>
      `Metis Design هو البديل الرسمي المحلي أولاً لـ Claude Design. يتحول agent البرمجة الذي تستخدمه — Claude Code أو Codex أو Cursor أو Gemini أو OpenCode أو Qwen — إلى محرك تصميم يعتمد على ${skills} skills قابلة للتركيب و ${systems} أنظمة DESIGN.md قابلة للنقل.`,
    ...
    officialAria: 'المصدر الرسمي لـ Metis Design',
    ...
    about: {
      ...
      caption: 'دراسات في الشكل · الإدراك · الخيال الآلي. (Metis Design, MMXXVI)',
    },
    capabilities: {
    ...
    testimonial: {
      ...
      label: 'المتعاونون',
      quote: '“حوّل Metis Design أفكار AI الغامضة إلى نظام بصري حاد وموثوق وجديد فعلاً.”',
    ...
    faqSection: {
      ...
      label: 'أسئلة Metis Design الشائعة',
  ...
  tr: homeFallbackCopy({
    railRight: 'Metis Design — cilt 01 · sayı nº 26 · Apache-2.0',
    railLeft: 'Skill · sistem · agent · BYOK · local-first',
    discordAria: 'Metis Design Discord’a katıl',
    ...
    heroLead: (skills, systems) =>
      `Metis Design, Claude Design’ın resmi local-first alternatifidir. Kullandığın coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode veya Qwen — ${skills} birleştirilebilir skill ve ${systems} taşınabilir DESIGN.md sistemiyle bir tasarım motoruna dönüşür.`,
    ...
    officialAria: 'Metis Design resmi kaynağı',
    ...
    about: {
      ...
      caption: 'Form · algı · makine imgelemi çalışmaları. (Metis Design, MMXXVI)',
    },
    capabilities: {
    ...
    work: {
      ...
      editedBy: 'Metis Design editörlüğü',
    ...
    testimonial: {
      ...
      label: 'İşbirlikçiler',
      quote: '“Metis Design belirsiz AI fikirlerini keskin, güvenilir ve gerçekten yeni bir görsel sisteme dönüştürdü.”',
  ...
  uk: homeFallbackCopy({
    railRight: 'Metis Design — том 01 · випуск № 26 · Apache-2.0',
    railLeft: 'Skills · системи · агенти · BYOK · local-first',
    discordAria: 'Приєднатися до Discord Metis Design',
    ...
    heroLead: (skills, systems) =>
      `Metis Design — офіційна local-first альтернатива Claude Design. Ваш coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode або Qwen — стає design engine із ${skills} composable skills та ${systems} portable DESIGN.md systems.`,
    ...
    officialAria: 'Офіційне джерело Metis Design',
    ...
    about: {
      ...
      caption: 'Дослідження форми · сприйняття · машинної уяви. (Metis Design, MMXXVI)',
    },
    capabilities: {
    ...
    work: {
      ...
      editedBy: 'Редакція Metis Design',
    ...
    testimonial: {
      ...
      label: 'Співтворці',
      quote: '«Metis Design допоміг перетворити нечіткі AI-ідеї на гостру, надійну й справді нову візуальну систему.»',
