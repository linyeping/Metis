# Pricing — Metis Design

Metis Design is **free and open-source**. The desktop app (macOS, Windows, Linux)
...
Nothing is proxied through Metis Design.
...
not required to use Metis Design.
...
- Model access: **BYOK** — bring your own provider key; API usage bills to your
  own account, never proxied through Metis Design
...
- The open-source desktop app is always free; the paid tiers are an optional
  ...
  requirement to use Metis Design.
