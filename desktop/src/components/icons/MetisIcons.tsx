...
export function CoworkTaskIcon({
  ...
  return (
    ...
    >
      {/* 左上格：代码 </> — 中心 (6, 7) */}
      <path d="M4 5.75L2.5 7 4 8.25" />
      <line x1="6.8" y1="5" x2="5.2" y2="9" />
      <path d="M8 5.75L9.5 7 8 8.25" />

      {/* 右上格：搜索放大镜 — 中心 (17.5, 6.5) */}
      <circle cx="17.5" cy="6.5" r="2.2" />
      <line x1="19.1" y1="8.1" x2="20.7" y2="9.7" />

      {/* 左下格：文档三行 — 中心 (6, 17) */}
      <line x1="2.5" y1="15.5" x2="9.5" y2="15.5" />
      <line x1="2.5" y1="17.5" x2="9.5" y2="17.5" />
      <line x1="2.5" y1="19.5" x2="7" y2="19.5" />
